...
(* OASIS_START *)
(* DO NOT EDIT (digest: 01693f4542de1d1b2d701e9561a14633) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "node.ml"; });
               Executable
                 ({
                     cs_name = "test_events";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_events.ml"; });
               Doc
                 ({
                     cs_name = "api";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some ">\133=\234\025\156\148\236\220u\151\232]\255]j";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
