...
(* OASIS_START *)
(* DO NOT EDIT (digest: 99f2047f86abfced21bb0c21be4692fd) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Vchan"; "Vchan_t"; "Vchan_wire"];
                      lib_pack = false;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "node_cli.ml"});
               Doc
                 ({
                     cs_name = "api";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "j\252#\214\180\218k\005\003\1887\152\243a\189%";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
